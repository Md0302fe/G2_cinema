    ...
    <body>
                    ...
                    <div class="choose_seat">
                        <ul class="seat_layout">
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="L">
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="K">
                                        <span class="seat_numbers">1</span>
                                    </button>
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="J">
                                        <span class="seat_numbers">1</span>
                                    </button>
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="I">
                                        <span class="seat_numbers">1</span>
                                    </button>
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="H">
                                        <span class="seat_numbers">1</span>
                                    </button>
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="G">
                                        <span class="seat_numbers">1</span>
                                    </button>
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="F">
                                        <span class="seat_numbers">1</span>
                                    </button>
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="E">
                                        <span class="seat_numbers">1</span>
                                    </button>
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="D">
                                        <span class="seat_numbers">1</span>
                                    </button>
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="C">
                                        <span class="seat_numbers">1</span>
                                    </button>
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="B">
                                        <span class="seat_numbers">1</span>
                                    </button>
                            ...
                            <li class="seat_items">
                                ...
                                <div class="seats">
                                    <button class="border_seats border rounded" data-label="A">
                                        <span class="seat_numbers">1</span>
                                    </button>
                ...
                <div class="content_right">
                    <div class="booking_summary">
                        ...
                        <div class="booking_bottom flex">
                            ...
                            <button class="text_continute border border-white rounded pd-t-10px" onclick="redirectToServlet()">
                                <p>Tiếp tục</p>
                            </button>
        ...
        <script>
            function redirectToServlet(id) {
                window.location.href = "BookingServlet?id=2";
            }
        </script>
