...
<html>
    ...
    <body>
            ...
            <div class="Main_Body grid">
                <div class="Main_Content grid wide">
                    <div class="navigation-body">
                        <h1 style="cursor: pointer" onclick="HOME()" class="navi-body_title">PHIM </h1>
                        <div class="navigation-body_items">
                            <div onclick="handle_phimdangchieu()" class="navigation-body_item" id="1">
                                <h2>Đang chiếu</h2>
                            </div>
                            <div onclick="handleInComing()" class="navigation-body_item" id="2">
                                <h2>Sắp chiếu</h2>
                            </div>
                    ...
                    <div class="HANDLE_MOVIE" id="HANDLE_MOVIE">
                    ...
                    <div  id="INFO-TEXT" class="info_movie hidden">
                        ...
                        <div class="Blog_content-items row col">
                            <div class="Blog_left col c-12 m-6 ">
                                <div class="blog_main_img">
                                    <img src="./Assets/Image/Blog_Image/exhuma.jpeg" alt="ERROR">
                                </div>
                                ...
                                <div class="blog_orther">
                                    <div class="blog_item">
                                        <div class="container_blog-other">
                                            <img style="    object-fit: contain;
                                                 width: 85%;" src="./Assets/Image/Blog_Image/kung-fu-panda-4-gau-truc-po-vat-va-tim-nguoi-ke-nghiep-6_1710236694045.jpg" alt="">
                                        </div>
                                        <div>
                                            <div class="blog_1_des">
                                                [Review] Kung Fu Panda 4: Gấu Trúc Po "Vật Vã" Tìm Người Kế Nghiệp!
                                            </div>
                                            <div class="icon-box">
                                                <div class="like-icon">
                                                    <i class="fas fa-thumbs-up"></i>
                                    ...
                                    <div class="blog_item">
                                        <div class="container_blog-other">
                                            <img style="
                                                 object-fit: contain;
                                                 width: 85%;" src="./Assets/Image/Blog_Image/review-dune-2-750_1709614144537.jpg" alt="">
                                        </div>
                                        <div>
                                            <div class="blog_1_des">
                                                [Review] Dune Part Two: Bộ Phim Sử Thi Hay Nhất Trong 10 Năm Qua?
                                            </div>
                                            <div class="icon-box">
                                                <div class="like-icon">
                                                    <i class="fas fa-thumbs-up"></i>
                                    ...
                                    <div class="blog_item">
                                        <div class="container_blog-other">
                                            <img class="kimetMobile" style="    object-fit: contain;
                                                 width: 134%;" src="./Assets/Image/Blog_Image/demon-slayer-kimetsu-no-yaiba---to-the-hashira-training-man-nhan-xung-tam-thuong-hieu-diet-qu-1_1709023345248.jpg" alt="">
                                        </div>
                                        <div class="desKimetMobile" style="padding-left: 20%">
                                            <div class="blog_1_des">
                                                [Review] Demon Slayer Kimetsu No Yaiba - To the Hashira Training: Mãn Nhãn Xứng Tầm Thương Hiệu Diệt Quỷ
                                            </div>
                                            <div class="icon-box">
                                                <div class="like-icon">
                                                    <i class="fas fa-thumbs-up"></i>
        ...
        <script>
            ...
            function handle_phimdangchieu() {
                $.ajax({
                    type: "GET",
                    url: "/CINEMA/phimsapchieu",
                    success: function (data) {
                        var row = document.getElementById("HANDLE_MOVIE");
                        row.innerHTML = data;
                    }
                });
            }
            ...
            function hidden_blog() {
                ...
                document.getElementById("INFO-TEXT").classList.add("add_blog");
            }
