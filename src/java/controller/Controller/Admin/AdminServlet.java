...
public class AdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String todayMoney = dao.getTotalMoney();
        String totalUser = dao.getTotalUser();
        String monthMoney = dao.getTotalMoneyOfMonth();
        String totalBooking = dao.getTotalBooking();
        
        String totalMovie = dao.getTotalMovie();
        String totalSchedule = dao.getTotalSchedule();
